      ...
      <div class="container">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title float-left">Tasks</h3>

            <inertia-link as="button" class="btn btn-primary btn-sm float-right" :href="route('createTask')">
          ...
          <div class="card-body p-0">
            <table class="table table-striped tasks">
              ...
              <tr v-for="(item, index) in this.$page.props.data" :key="index">
                ...
                <td class="task-tasks text-right">

                  <inertia-link class="btn btn-primary btn-sm" :href="route('viewTask',[item.id])">
                    <i class="fas fa-folder">
                    </i>
                    View
                  </inertia-link>

                  <inertia-link class="btn btn-info btn-sm" :href="route('editTask',[item.id])">
          ...
          <div class="modal-dialog">
            <div class="modal-content bg-danger">
              <div class="modal-header">
                <h4 class="modal-title">Deleting Task</h4>
