      ...
      <div class="container">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <inertia-link as="button" class="btn btn-primary btn-sm float-right" :href="route('createAction')">
            ...
            <table class="table table-striped actions">
              ...
              <tr v-for="(item, index) in this.$page.props.data" :key="index">
                ...
                <td class="action-actions text-right">
                  ...
                  <inertia-link class="btn btn-primary btn-sm" :href="route('viewAction',[item.id])">
                    <i class="fas fa-folder">
                    </i>
                    View
                  </inertia-link>

                  <inertia-link class="btn btn-info btn-sm" :href="route('editAction',[item.id])">
...
export default {
    ...
    methods: {
        ...
        remove() {
            this.$inertia.post(route('deleteAction'), {
                id: this.item_id
            },{
                onFinish: () => {
                  this.item_id = null;
